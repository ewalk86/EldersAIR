...
author: "Ethan Walker"
date: "Started 10 Feb 2020, Updated 10 Aug 2020"
output: pdf_document
---
...
np_adult_initial <- read_xlsx(paste0(file_path, "Input/NP/adult.xlsx"), skip = 1,
                               na = c("", "NULL"),
...
# Load files 
## Box location: Update Box location once final data loaded
np_demographics_initial <- read_xlsx(paste0(file_path, "Input/NP/demographics.xlsx"),
                                      na = c("", "NULL")) %>% 
  rename_all(tolower) %>% 
...
## Box location: Update Box location once final data loaded
np_homewinter_initial <- read_xlsx(paste0(file_path, "Input/NP/homewinter.xlsx"), 
                                   skip = 1, na = c("", "NULL"),
...
## Box location: Update Box location once final data loaded
np_home_initial <- read_xlsx(paste0(file_path, "Input/NP/home.xlsx"), na = c("", "NULL")) %>% 
  rename_all(tolower) %>% 
