...
np_medvisit_initial <- read_xlsx(paste0(file_path, "Input/NP/np_medicalvisit_20200220.xlsx"))
...
## Box location: Update Box location once final data loaded
nn_medvisit_initial <- read_xlsx(paste0(file_path, "Input/NN/nn_medicalvisit_20200220.xlsx"))
