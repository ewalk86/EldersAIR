...
np_temp_rh_initial <- read_xlsx("Input/NP/np_qtrack_20200225.xlsx") %>% 
  # rename variables
...
## Box location: Update Box location once final data loaded
nn_temp_rh_initial <- read_xlsx("Input/NN/nn_qtrack_20200225.xlsx") %>% 
  # rename variables
  mutate(home_winter_id = factor(HomeWinterID),
         rh_indoor_current = as.numeric(RelHumCur),
         rh_indoor_max = as.numeric(RelHumMax),
...
#write_rds(elders_temp_rh, "Output/elders_temp_rh.rds")
```
...
```{r}
elders_temp_rh <- read_rds("Output/elders_temp_rh.rds")
...
# write_rds(elders_temp_rh_clean, "Output/elders_temp_rh_clean.rds")

elders_temp_rh_clean <- read_rds("Output/elders_temp_rh_clean.rds")
```
