...
fun_data <- elders_medvisit %>% 
  ...
  mutate(hyp_any = if_else(hypertension == "Yes" | lead(hypertension) == "Yes", "Yes", "No"),
         obs_any = if_else(obstruction == "Yes" | lead(obstruction) == "Yes", "Yes", "No")) %>% 
  ungroup() %>% 
...
medvisit_summary_function(fun_data, "hyp_any", "Stage 2 \nhypertension")
medvisit_summary_function(fun_data, "obs_any", "Obstruction")
```
