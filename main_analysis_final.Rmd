---
title: 'EldersAIR: Main analysis final frameworks'
author: "Ethan Walker"
date: "Started 16 April 2021; Updated 5 May 2021"
output: pdf_document
---
...
er_data_4row <- analysis_data %>% 
  ...
  dplyr::select(area, home, adult_id_char, winter_id, sampling_visit, pm_mean_visit,
                cohort, treatment, outcome, income, education, residents_smoke, 
                home_sqm_2level, burn_level, gender, chimney_clean, stove_age, 
                stove_grade, age, bmi, visit_intervention_diff, pm_mean_at_home_visit,
                treatment_filter_type, filter_compliance, kw_perc_expected) %>% 
...
er_results_primary <- lmer(outcome ~ pm_iqr + winter_id + 
...
tidy_results_combined <- rbind(tidy_results_primary, , 
                               )
